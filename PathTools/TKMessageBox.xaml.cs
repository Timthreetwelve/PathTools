...
namespace TKUtils
{
    ...
    public sealed partial class TKMessageBox : Window
    {
        ...
        public static MessageBoxResult Show(string msg, string caption, MessageBoxType type)
        {
            return type switch
            {
                MessageBoxType.ConfirmationWithYesNo => Show(msg, caption, MessageBoxButton.YesNo, MessageBoxImage.Question),
                MessageBoxType.ConfirmationWithYesNoCancel => Show(msg, caption, MessageBoxButton.YesNoCancel, MessageBoxImage.Question),
                MessageBoxType.Information => Show(msg, caption, MessageBoxButton.OK, MessageBoxImage.Information),
                MessageBoxType.Error => Show(msg, caption, MessageBoxButton.OK, MessageBoxImage.Error),
                MessageBoxType.Warning => Show(msg, caption, MessageBoxButton.OK, MessageBoxImage.Warning),
        ...
        #endregion Pick Image (when needed)
